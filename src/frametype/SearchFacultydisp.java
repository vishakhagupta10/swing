...
import java.sql.*;
class SearchFacultydisp extends JFrame
{
	Container c;
	JTable t;
	JMenuBar mb1,mb2,mb3,mb4;

public 	SearchFacultydisp(String id1)
	{
		c=this.getContentPane();
		c.setLayout(new BorderLayout());
				
		String heading[]={"Receptionist id","name","gender","qualification","Expert Area","address","salary","mobile no","email","pan","Date of joining" };
		int sn = 1;
