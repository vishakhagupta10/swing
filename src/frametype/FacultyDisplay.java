...
import java.sql.*;
class FacultyDisplay extends JFrame
{
	Container c;
	JTable t;
	...
	FacultyDisplay()
	{
		...
		String heading[]={"faculty_id","name","gender","Qualification","Expert Area","Address","salary","mobile","email","PAN","Date of joining"};
		int sn = 1;
